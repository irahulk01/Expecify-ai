...
import { 
  Plus, Bell, Search, Home, Zap, Tv, CreditCard, ChevronRight, AlertCircle, Clock, Phone, Mic
} from "lucide-react";
      ...
      <main className="px-6 md:px-10 py-8 space-y-10 animate-fade-in-up">
        ...
        <div className="flex overflow-x-auto hide-scrollbar snap-x snap-mandatory -mx-6 px-6 pb-6 gap-6 md:grid md:grid-cols-2 lg:grid-cols-3 md:mx-0 md:px-0 md:pb-0">
          {filteredBills.map((bill) => {
            ...
            return (
              <div key={bill.id} className="bg-surface border border-border rounded-[2.5rem] p-8 shadow-sm hover:shadow-md transition-all group relative overflow-hidden shrink-0 w-[85%] md:w-auto snap-center">
