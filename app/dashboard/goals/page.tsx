  ...
  return (
    <div className="min-w-0 transition-all">
      ...
      <main className="px-6 md:px-10 py-8 space-y-10 animate-fade-in-up">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-text-secondary font-medium">
              Visualizing your future, one contribution at a time.
            </p>
          </div>
        ...
        <div className="flex overflow-x-auto hide-scrollbar snap-x snap-mandatory -mx-6 px-6 pb-6 gap-8 md:grid md:grid-cols-2 md:mx-0 md:px-0 md:pb-0">
          {goals.map((goal, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-surface border border-border rounded-[3rem] p-10 shadow-sm hover:shadow-md transition-all group shrink-0 w-[85%] md:w-auto snap-center"
              >
                <div className="flex items-start justify-between mb-10">
                  <div
                    className={`w-20 h-20 rounded-[2rem] bg-primary/10 text-primary flex items-center justify-center shadow-lg shadow-current/5`}
                  >
                    <Icon className="w-10 h-10" />
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] uppercase font-black text-text-secondary tracking-widest mb-2">
                      Target Date
                    </p>
                ...
                <div className="mb-10">
                  <h4 className="text-2xl font-black text-text-primary mb-2 tracking-tight">
                    {goal.title}
                  </h4>
                ...
                <div className="space-y-4">
                  ...
                  <div className="h-4 bg-background border border-border rounded-full overflow-hidden p-1">
                    <div
                      className="h-full bg-primary rounded-full shadow-[0_0_10px_rgba(45,212,191,0.5)] transition-all duration-1000"
          ...
          <div className="border-2 border-dashed border-border rounded-[3rem] bg-linear-to-b from-surface to-background/50 flex flex-col items-center justify-center p-12 text-center group cursor-pointer hover:border-primary/50 transition-all shrink-0 w-[85%] md:w-auto snap-center">
            ...
            <p className="text-sm text-text-secondary font-medium px-10">
              Define a new financial target and let our AI suggest an optimal savings plan.
            </p>
          </div>
        </div>
      </main>
