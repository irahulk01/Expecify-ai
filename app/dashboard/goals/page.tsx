...
import { 
  Plus, Bell, Search, Target, Plane, Home, Car, TrendingUp, ChevronRight, Mic
} from "lucide-react";
      ...
      <main className="px-6 md:px-10 py-8 space-y-10 animate-fade-in-up">
        ...
        <div className="flex overflow-x-auto hide-scrollbar snap-x snap-mandatory -mx-6 px-6 pb-6 gap-8 md:grid md:grid-cols-2 md:mx-0 md:px-0 md:pb-0">
          {goals.map((goal, i) => {
            ...
            return (
              <div key={i} className="bg-surface border border-border rounded-[3rem] p-10 shadow-sm hover:shadow-md transition-all group shrink-0 w-[85%] md:w-auto snap-center">
